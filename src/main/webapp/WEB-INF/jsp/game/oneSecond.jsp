...
<html>
    ...
    * {margin:0; padding: 0;}
    ...
    #box {width:100%;height:100%;background:url(http://cgzp.cdn.novorunning.com/second/images/top_bg01.jpg) repeat;text-align: center;}
   ...
   <body>
        <div id="box">
            ...
            <div class="share-btn" style="margin-top:20px" id="share_zhuangbi" onclick >点我三下有惊喜</div>

            <div id="zhuangbiFrame" style="display:none;">
                <div class="share-btn" id="zhuangyixia">装逼一下</div>
                <div class="label-des"><input id="zhuangbi_text" type="text" placeholder="输入完描述文案，点击装逼一下"></div>
            </div>
